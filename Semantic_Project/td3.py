...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims, fc3_dims, n_actions, name,
        ...
        T.nn.init.uniform_(self.action_value.weight.data, -f5, f5)
        T.nn.init.uniform_(self.action_value.bias.data, -f5, f5)
...
class Agent_TD3(object):
    def __init__(self, alpha, beta, input_dims, tau, gamma=0.99,
                 n_actions=12, max_size=1000000, c_layer1_size=1024,
                 c_layer2_size=512, c_layer3_size=256, a_layer1_size=512, a_layer2_size=256, batch_size=64,
                 update_actor_interval=2, noise='OU'):
        self.layer1_size = c_layer1_size
        self.layer2_size = c_layer2_size
        self.layer3_size = c_layer3_size
        self.layer4_size = a_layer1_size
        self.layer5_size = a_layer2_size
        self.gamma = gamma
        self.tau = tau
        ...
        self.actor = ActorNetwork(alpha, input_dims, self.layer4_size,
                                  self.layer5_size, n_actions=n_actions,
                                  name='Actor')
        ...
        self.target_actor = ActorNetwork(alpha, input_dims, self.layer4_size,
                                      self.layer5_size, n_actions=n_actions,
                                         name='TargetActor')
